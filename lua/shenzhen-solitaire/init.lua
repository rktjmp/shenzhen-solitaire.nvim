 ...
 local _3_, _4_ = coroutine.resume(thread, "event", event) if ((_3_ == true) and ((_G.type(_4_) == "table") and ((_4_)[1] == "ok") and true)) then local _ = (_4_)[2]
 return nil elseif ((_3_ == true) and ((_G.type(_4_) == "table") and ((_4_)[1] == "err") and (nil ~= (_4_)[2]))) then local e = (_4_)[2]
 return error((e .. debug.traceback(thread))) elseif ((_3_ == false) and (nil ~= _4_)) then local e = _4_
 return error((e .. debug.traceback(thread))) else return nil end end

 M["start-new-game"] = function(buf_id, _3fconfig, _3fseed)


 local hl_normal_background do local _let_6_ = vim.api.nvim_get_hl_by_name("Normal", true) local background = _let_6_["background"]
