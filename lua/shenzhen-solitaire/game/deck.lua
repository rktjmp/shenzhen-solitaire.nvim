 ...
 local function _3_(_, s) local function _4_() return iter_2frange(1, 9) end local function _5_(_241) return {s, _241} end return E.map(_4_, _5_) end


 local function _6_(_, s) local function _7_() return iter_2frange(1, 4) end local function _8_() return {s, 0} end return E.map(_7_, _8_) end D = E.flatten({E["flat-map"]({"STRING", "COIN", "MYRIAD"}, _3_), {{"FLOWER", 0}}, E["flat-map"]({"DRAGON-RED", "DRAGON-GREEN", "DRAGON-WHITE"}, _6_)})
